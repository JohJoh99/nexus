...
public class PacketClientGeneralPublicKey extends Packet {

	private static final String MODULUS = "modulus";
	private static final String EXPONENT = "exponent";
	
	public PacketClientGeneralPublicKey() {
		super(PacketType.CLIENT_GENERAL_PUBLIC_KEY);
	}
	
	public PacketClientGeneralPublicKey(BigInteger modulus, BigInteger exponent) {
		super(PacketType.CLIENT_GENERAL_PUBLIC_KEY);
